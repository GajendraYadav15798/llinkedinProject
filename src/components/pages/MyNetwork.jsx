        ...
        <div className="network-div">
          <div className="manage-div">
            ...
            <div className="div1">
              ...
              <span  style={{marginLeft:"120px", color:"rgba(0,0,0,0.6)"}}>99</span>
            </div>
            <div className="div2">
              <PermContactCalendarIcon className="forIconColor" />
              <span style={{color:"rgba(0,0,0,0.6)"}}>Contacts</span>
              <span style={{marginLeft:"145px", color:"rgba(0,0,0,0.6)"}}>100</span>
            </div>
            <div className="div3">
            ...
            <div className="div4">
              ...
              <span  style={{marginLeft:"165px", color:"rgba(0,0,0,0.6)"}}>78</span>
            </div>
            <div className="div5">
            ...
            <div className="div6">
              ...
              <span style={{marginLeft:"170px", color:"rgba(0,0,0,0.6)"}}>87</span>
            </div>
            <div className="div7">
              <UnsubscribeIcon className="forIconColor" />

              <span style={{color:"rgba(0,0,0,0.6)"}}>Mail</span>
