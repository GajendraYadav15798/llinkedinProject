...
import { getPosts } from "../components/utils/getPostApi";
import { emptyImage } from "../images/emptyPost.jpg";
import { ReactComponent as emptyPost } from "../components/assets/emptyResult.svg";
const Home = () => {
              ...
              return (
                <div key={index} className="posts">
                  ...
                  <div className="post-body">
                    ...
                    <img
                      className="mainImage"
                      src={posts.channel ? posts.channel.image : ""}
                      alt=""
                    />
                    <br />
                    <img
